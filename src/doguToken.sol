...
contract PepeToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 public constant amountForAdmin = 8_000_000_000 * (10 ** _decimals);
     ...
     */
    constructor() {
        _name = "Doge Unchained";
        _symbol = "DOGU";
        _mint(msg.sender, amountForAdmin);
    }
